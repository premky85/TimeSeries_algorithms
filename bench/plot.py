...
data = pd.concat([data_fw, data_bk, data_diag, data_fwbk, data_fwbk_par, data_prunned, data_diag_par], axis=1)
data.columns = ["time_fw", "time_bk", "time_diag", "time_fwbk", "time_fwbk_par", "time_prunned", "time_diag_par"]
